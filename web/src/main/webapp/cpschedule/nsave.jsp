    ...
    <div class="content_right2">
    	<div class="content_left_con4">
            ...
            <div class="tab_select_box3 ClearFix"	>
            	<h3 class="title_jiandu_font">民生检察联络点维护</h3>
                <div class="forem_box_set">
                <form id="updatefm" method="post" novalidate>
                    <table cellpadding="0" cellspacing="0" class="tab_padding_t">
                    <tr>
                         <td align="right">所属片区：</td>
                         <td> 
                         <input type="hidden" name="id"  id="id" value="${requestScope.cpSchedule.id}" />                              
                         <select id="areaid" class="easyui-combobox easyui-validatebox" name="areaid" required="true" style="width:220px">
                        ...
                        <tr>
                            ...
                            <td>                            
                            <input type="text" name="worktime" class="easyui-validatebox w220" required="true" value="${requestScope.cpSchedule.worktime}" />
                            </td>
                        </tr> 
                        <tr>
...
$("#areaid").val("${requestScope.cpSchedule.areaid}");
$("#orgid").val("${requestScope.cpSchedule.orgid}");
$("#leadid").val("${requestScope.cpSchedule.leadid}");
$("#officeid").val("${requestScope.cpSchedule.officeid}");
...
function save(){
	...
	if($("#id").val()>0)
	{
		url="${pageContext.request.contextPath}/cpschedule/update";	
	}
	else
	{
		url="${pageContext.request.contextPath}/cpschedule/create";	
	}
	$.ajax({
            url: url,
