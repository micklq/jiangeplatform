...
<div class="content_box">
    ...
    <div class="tab_select_box3 ClearFix">
        <h3 class="title_jiandu_font" style="border-bottom:none;">日程管理<a href="${pageContext.request.contextPath}/cpschedule/nsave?id=0" class="add_tianji_keshi">添加检察点+</a></h3>
        <ul class="tab_nav_sfs">
        	<li><a class="hover" href="${pageContext.request.contextPath}/cpschedule/nlist">民生检察点</a></li>
            <li><a href="${pageContext.request.contextPath}/wsschedule/nlist">阳光工作站</a></li>                    
        </ul>
        <div class="box_tabls">
          <div class="r prev_next" style="margin:10px;">
           <a href="${pageContext.request.contextPath}/cpschedule/nlist?page=${requestScope.prePage}">上一页</a>
           <span>${requestScope.currentPage}/${requestScope.pageCount}</span>
           <a href="${pageContext.request.contextPath}/cpschedule/nlist?page=${requestScope.nextPage}">下一页</a>
           </div>
            <!--联络点-->
            <div class="forem_box_set1 tabse_se">                
                <table cellpadding="0" cellspacing="0" class="tab_padding_t1">
                    ...
                    <tr>                        
                        ...
                        <td>${p.officename}</td>  
                        <td>
                        <a href="${pageContext.request.contextPath}/cpschedule/nsave?id=${p.id}">修改 </a>
...
function del(id){
	var url="${pageContext.request.contextPath}/cpschedule/delete?id="+id;	
		 ...
		 $.ajax({
	            ...
	            success: function (result){
	                if (result[ "success"]== true){  
	                	location.href="${pageContext.request.contextPath}/cpschedule/nlist";                    
	                } else {
