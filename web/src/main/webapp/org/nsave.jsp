    ...
    <div class="content_right2">
    	<div class="content_left_con4">
            ...
            <div class="tab_select_box3 ClearFix"	>
            	<h3 class="title_jiandu_font">科室维护</h3>
                 ...
                 <form id="updatefm" method="post" novalidate>
                    <table cellpadding="0" cellspacing="0" class="tab_padding_t">
                        <tr>
                            ...
                            <td>
                            <input type="hidden" name="id"  id="id" value="${requestScope.org.id}" />
                            <input type="text" name="name" class="easyui-validatebox w220" required="true" value="${requestScope.org.name}" />
                            </td>
                        </tr>
                        <tr>
                            <td></td>
