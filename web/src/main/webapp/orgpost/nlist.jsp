...
<div class="content_box">
    ...
    <div class="tab_select_box3 ClearFix">
        <h3 class="title_jiandu_font" style="border-bottom:none;">职务管理<a href="${pageContext.request.contextPath}/orgpost/nsave?id=0" class="add_tianji_keshi">添加职务+</a></h3>
        <ul class="tab_nav_sfs">
        	<li><a href="${pageContext.request.contextPath}/org/nlist">科室</a></li>            
            <li><a class="hover" href="${pageContext.request.contextPath}/orgpost/nlist">职务</a></li>            
        </ul>
        <div class="box_tabls">
         <div class="r prev_next" style="margin:10px;">
          <a href="${pageContext.request.contextPath}/orgpost/nlist?page=${requestScope.prePage}">上一页</a>
          <span>${requestScope.currentPage}/${requestScope.pageCount}</span>
          <a href="${pageContext.request.contextPath}/orgpost/nlist?page=${requestScope.nextPage}">下一页</a>
         </div>
        <div class="forem_box_set1 tabse_se">
            <table cellpadding="0" cellspacing="0" class="tab_padding_t1">
                <tr>   
                 ...
                 <c:forEach items="${orgPostList}" var="p">                
                <tr>                    
                    <td>${p.id}</td>
                    <td>${p.name}</td>                            
                    <td>
                    <a href="${pageContext.request.contextPath}/orgpost/nsave?id=${p.id}">修改 </a>
...
function del(id){
	var url="${pageContext.request.contextPath}/orgpost/delete?id="+id;	
